...
namespace b3d
{
	...
	/// <summary>Represents a vertical layout that will layout out its child elements top to bottom.</summary>
	[ShowInInspector]
	public partial class GUILayoutY : GUILayout
	{
		private GUILayoutY(bool __dummy0) { }
		protected GUILayoutY() { }
		...
		/// </param>
		public GUILayoutY(string styleClass, params GUIOption[] options)
		{
		...
		private static extern void Internal_Create(GUILayoutY managedInstance, string styleClass, params GUIOption[] options);
		[MethodImpl(MethodImplOptions.InternalCall)]
		private static extern void Internal_Create0(GUILayoutY managedInstance, params GUIOption[] options);
	}
