...
The tool must be compiled manually from its source: [https://github.com/BearishSun/BansheeCodeGenerator](https://github.com/BearishSun/BansheeCodeGenerator). You should follow instructions on its GitHub page on how to compile the tool.
